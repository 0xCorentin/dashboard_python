...
def create_cumulative_curve_new(df, production_cols):
    ...
    fig.update_layout(
        ...
        yaxis=dict(
            ...
            tickformat=".0f",
            ticksuffix="%",
            range=[0, 110]  # Augmenté pour laisser plus d'espace aux labels plus grands
        ),
        yaxis2=dict(
        ...
        uniformtext=dict(mode='show', minsize=15)  # Force l'affichage du texte avec une taille minimale
    )
